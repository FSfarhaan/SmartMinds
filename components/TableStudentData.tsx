...
const TableStudentData = () => {
  ...
  return (
    <View className="w-full rounded-2xl p-2 pt-0">
      {/* Top Bar */}
      ...
      <View className="flex-row justify-between items-center mb-4">
        ...
        <TouchableOpacity className="bg-primary px-3 py-2 rounded-lg flex-row items-center justify-center">
          <Ionicons
            ...
            style={{ marginRight: 5 }}
          />
          <AppTextSB className="text-white text-sm font-semibold">Add Student</AppTextSB>
        </TouchableOpacity>
      </View>
                    ...
                    {options.map((option) => (
                      <TouchableOpacity
                        ...
                        className={`px-4 py-2 rounded-full ${
                          tempFilter[key as keyof FilterState] === option
                            ? "bg-blue-500"
                            : "bg-gray-200"
                        }`}
                        onPress={() =>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => (
              ...
              >
                ...
                <View
                  style={{
                    width: columnWidths.leavingDate,
                    paddingHorizontal: 12,
                    paddingVertical: 8,
                    justifyContent: "center",
                  }}
